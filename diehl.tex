...
Dieses Interface bietet eine Queue (Puffer) an. Wenn die Queue voll ist wartet der Produzent (\verb|put(element)|). Wenn die Queue leer ist wartet der Konsument (\verb|take()|).
