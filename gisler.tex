...
Stellt sicher, dass von einer Klasse immer nur genau ein Objekt vorhanden ist, mittels einem privaten Konstruktor und einer \texttt{getInstance()}-Methode. Sparsam einsetzen, sonst enstehen sternförmige Abhängigkeiten zur Singletonklasse.
...
\subsubsection{Strategy (Verhaltensmuster)}\label{sec:strategypattern}
 Die Lösung für \texttt{switch() case:} Statements oder wenn unterschiedliches Verhalten erriecht werden soll. 
